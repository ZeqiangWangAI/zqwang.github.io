...
My primary research direction focuses on the application of Natural Language Processing (NLP) in longitudinal social science and biomedical datasets, dedicated to solving complex interdisciplinary problems through artificial intelligence technologies. My specific research interests include measuring social biases in Large Language Models (LLMs), cross-lingual knowledge transfer of sociological concepts, and broader NLP-based computational social science research.
